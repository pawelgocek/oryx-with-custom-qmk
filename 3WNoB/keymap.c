...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_CIRC,        MT(MOD_LSFT, KC_0),MT(MOD_LCTL, KC_4),MT(MOD_LALT, KC_5),MT(MOD_LGUI, KC_6),KC_PERC,                                        KC_MINUS,       TD(DANCE_0),    MT(MOD_RALT, KC_LBRC),MT(MOD_RCTL, KC_RBRC),TD(DANCE_1),    KC_DLR,         
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_CIRC,        TD(DANCE_2),    MT(MOD_LCTL, KC_MINUS),TD(DANCE_3),    MT(MOD_LGUI, KC_EQUAL),KC_PLUS,                                        KC_LBRC,        TD(DANCE_4),    TD(DANCE_5),    MT(MOD_RCTL, KC_RBRC),TD(DANCE_6),    KC_DLR,         
